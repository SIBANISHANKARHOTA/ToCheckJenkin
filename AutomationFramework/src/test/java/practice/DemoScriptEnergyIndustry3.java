...
public class DemoScriptEnergyIndustry3 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.name("accountname")).sendKeys("Abhishek_Wipro1"+random);
		...
		if (orgname.contains("Abhishek_Wipro1"+random)) {
